...
MAPREDUCE_MINIMUM_DRIVER_MEMORY_MB = args['MAPREDUCE_MINIMUM_DRIVER_MEMORY_MB']
if (MAPREDUCE_MINIMUM_DRIVER_MEMORY_MB < 512):
    log.fatal("Containers less than {0}MB are not supported".format(MAPREDUCE_MINIMUM_DRIVER_MEMORY_MB))
elif (MAPREDUCE_MINIMUM_DRIVER_MEMORY_MB != (MAPREDUCE_MINIMUM_DRIVER_MEMORY_MB / 512) * 512):
    log.fatal("{0} must be dividable by {1}".format('MAPREDUCE_MINIMUM_DRIVER_MEMORY_MB', 512))
...
SPARK_YARN_DRIVER_MEMORYOVERHEAD = max(384,MAPREDUCE_MINIMUM_DRIVER_MEMORY_MB * 0.07)
